...
export declare class Seaport {
     ...
     */
    constructor(providerOrSigner: JsonRpcProvider | Signer, { overrides, ascendingAmountFulfillmentBuffer, balanceAndApprovalChecksOnOrderCreation, conduitKeyToConduit, seaportVersion, }?: SeaportConfig);
    /**
